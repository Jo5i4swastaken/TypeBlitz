...
export function Sidebar({ difficulty, mode, onDifficultyChange, onModeChange, theme = "default", language = "English" }: SidebarProps) {
      ...
      <div className="flex flex-col gap-8">
        ...
        >
          <input
            ...
            className={`w-20 px-3 py-1.5 rounded text-[10px] ${
              theme === "paper"
        ...
        >
          <input
            ...
            className={`w-24 px-3 py-1.5 rounded text-[10px] ${
              theme === "paper"
                ? "bg-white border border-[#d1d5db] text-[#1a2332]"
                : theme === "soft"
                ? "bg-white/40 glass border border-white/20 text-[#1e293b]"
