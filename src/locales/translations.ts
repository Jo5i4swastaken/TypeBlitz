export const translations = {
  ...
  Spanish: {
    ...
    cyberpunk: "Cyberpunk",
    cyberpunkDesc: "Rosa y verde neón",
    paperInk: "Papel y Tinta",
    ...
    responseTimeDesc: "Generalmente respondemos en 24-48 horas",
  ...
  French: {
    ...
    cyberpunk: "Cyberpunk",
    cyberpunkDesc: "Rose et vert néon",
    paperInk: "Papier et Encre",
  ...
  German: {
    ...
    cyberpunk: "Cyberpunk",
    cyberpunkDesc: "Neon Pink & Grün",
    paperInk: "Papier & Tinte",
    ...
    messagePlaceholder: "Sagen Sie uns, was Sie denken...",
  ...
  Portuguese: {
    ...
    cyberpunk: "Cyberpunk",
    cyberpunkDesc: "Rosa e verde neon",
    paperInk: "Papel e Tinta",
    ...
    messageSentDesc: "Obrigado por nos contatar! A equipe TypeBlitz responderá o mais rápido possível.",
    closeButton: "Fechar",
  },
};
